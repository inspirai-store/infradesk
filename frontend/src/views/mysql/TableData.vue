          ...
          <NDataTable
            ...
            :columns="[
              ...
              { 
                ...
                key: 'nullable',
                width: 60,
                render: (row: { nullable: boolean }) => row.nullable ? '是' : '否'
              },
          ...
          <NDataTable
            :columns="[
              ...
              { 
                title: '字段', 
                key: 'columns',
                render: (row: { columns: string[] }) => row.columns.join(', ')
              },
              { 
                title: '唯一', 
                key: 'unique',
                width: 60,
                render: (row: { unique: boolean }) => row.unique ? '是' : '否'
              },
